  ...
  >([
    {
      ...
      activeIcon: getTabBarIcon('home_active')
    },
    {
      name: 'community',
    ...
    },
    {
      ...
      label: 'tabbar_ai',
      path: '/AIInvest',
      icon: getTabBarIcon('ai'),
      activeIcon: getTabBarIcon('ai_active')
    },
    {
      name: 'team',
      label: 'tabbar_team',
      path: '/Team',
      icon: getTabBarIcon('team'),
      activeIcon: getTabBarIcon('team_active')
    },
    {
      name: 'mine',
      label: 'tabbar_mine',
