<template>
  <div class="community-page-shell">
    <NavBar :title="t('cm_nav_title')" :show-left="false" fixed placeholder :border="false"
      ...
      <template #right>
        <div class="community-page__nav-publish" role="button" @click="goPublish">
          <span>{{ t('cm_go_publish') }}</span>
          <Icon name="add-o" :size="15" color="#3366ff" />
        </div>
      </template>
    </NavBar>
...
import { Tabs, Tab, Swipe, SwipeItem, PullRefresh, List, Empty, Image as VanImage, Icon } from 'vant';
