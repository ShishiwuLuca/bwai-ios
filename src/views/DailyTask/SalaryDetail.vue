...
<style scoped lang="less">
  ...
  .salary-page :deep(.van-nav-bar) {
    background: linear-gradient(180deg, #e8eeff 0%, @page-bg 100%);
  }

  .salary-page :deep(.van-nav-bar__title) {
    font-size: 0.32rem;
    font-weight: 600;
    color: @text;
  }

  .salary-page :deep(.van-nav-bar .van-icon) {
    color: @text;
  }

  .salary-page__content {
    padding: 0.24rem 0.32rem calc(0.48rem + env(safe-area-inset-bottom));
  }
