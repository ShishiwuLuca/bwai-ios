  ...
  <div class="about-page">
    ...
    <PageWrap>
      <div class="text-center mt-1">
        ...
        <div class="text-[0.3rem] text-[#8c8c8c] mt-[0.12rem]">{{ t('about_us_slogan') }}</div>
      </div>
      <div class="p-1">
        <Cell
          v-if="!isApp"
          ...
          size="large"
          :border="false"
          class="about-page__cell rounded mt-1 !pt-1 !pb-1 mb-1"
      ...
      <div class="fixed bottom-1 w-full p-1" v-if="isApp">
        <Button
          ...
          :style="{ background: 'linear-gradient(180deg, #92b6ff 0%, #2a61f9 100%)', border: 'none', color: '#fff' }"
