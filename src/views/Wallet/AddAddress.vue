<template>
  ...
  <PageWrap>
    <div class="flex flex-col gap-[0.32rem] p-[0.32rem]">
        ...
        <Popover v-model:show="showCurrencyPopover" :offset="[0, 8]" placement="bottom">
          <template #reference>
            <Cell
              ...
              class="add-address-page__cell !rounded-sm"
          ...
          >
            <Cell
              ...
              class="!bg-white !rounded-sm !pl-0.5 !pr-0"
      ...
      <div class="flex flex-col gap-[0.16rem]">
        <label class="text-[0.28rem] text-[#000] font-medium">{{ t('add_address_network') }}</label>
      ...
      <div class="flex flex-col gap-[0.16rem]">
        ...
        <Field
          ...
          clearable
          size="large"
          class="add-address-page__field !rounded-sm"
      ...
      <div class="flex flex-col gap-[0.16rem]">
        <label class="text-[0.28rem] text-[#000] font-medium">{{ t('add_address_wallet_name') }}</label>
        <Field
          clickable
          center
          clearable
    ...
    <div class="fixed bottom-0 left-0 right-0 p-1 bg-[#f2f5fe]">
      <Button v-if="isLoading" :loading="isLoading" class="add-address-page__submit-btn" block round />
      <Button v-else class="add-address-page__submit-btn" block round @click="onSubmit">
        {{ t('add_address_save') }}
      </Button>
    </div>
  </PageWrap>
