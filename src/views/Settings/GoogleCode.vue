<template>
  <PageWrap class="google-code-page min-h-screen">
    <!-- Unbind UI -->
    <template v-if="isBound">
      ...
      <div class="flex flex-col items-center p-1 pt-10">
        ...
        <div class="flex items-center gap-0.5 mb-1">
          ...
          <span class="text-[#000] text-[0.32rem] font-bold">{{ t('unbind_google_status') }}</span>
        </div>
      </div>
      <div class="p-1">
        <div class="mb-2">
          <div class="text-[#000] text-[0.28rem] mb-1">{{ t('unbind_google_code') }}</div>
          <Field
            clearable
            center
            size="large"
            ...
            autocomplete="off"
            class="google-code-page__field !rounded-sm"
            :border="false"
        ...
        <div class="w-full fixed bottom-0 left-0 p-1 bg-[#f2f5fe]">
          <Button type="primary" block round :loading="loading" class="google-code-page__btn" @click="submitUnbind">
    ...
    <template v-else>
      ...
      <template v-if="step === 1">
        ...
        <div class="flex flex-col items-center pt-10 px-4 pb-10">
          ...
          <div class="text-[#000] text-[0.36rem] font-bold mb-4">{{
            t('bind_google_step1_title')
          }}</div>
          <div class="text-[#8c8c8c] text-[0.26rem] text-center mb-10">{{
            t('bind_google_step1_desc')
          }}</div>

          <div class="w-full fixed bottom-0 left-0 p-4 bg-[#f2f5fe]">
            <div class="mb-1">
              <Button type="primary" block round class="google-code-page__btn" @click="downloadApp">
            ...
            <Button
              ...
              plain
              type="primary"
              class="google-code-page__outline-btn"
              @click="step = 2"
            >
              {{ t('bind_google_next') }}
            </Button>
      ...
      <template v-if="step === 2">
        ...
        <div class="flex flex-col items-center pt-6 p-1 pb-10">
          ...
          <div class="text-[#000] text-[0.36rem] font-bold mb-2">{{
            t('bind_google_step2_title')
          }}</div>
          <div class="text-[#8c8c8c] text-[0.26rem] text-center mb-6">{{
          ...
          <Field
            ...
            readonly
            class="google-code-page__field !rounded-sm mb-1"
            :border="false"
          >
            <template #button>
              <Icon
          ...
          <div
            class="w-full bg-[#FFF0F3] border border-[#E61546] rounded-sm p-1 flex items-start gap-0.5"
          >
      ...
      <template v-if="step === 3">
        ...
        <div class="p-1 pb-10">
          <div class="mb-1">
            <div class="text-[#000] text-[0.28rem] mb-1">{{
              t('bind_google_step3_account_name')
            }}</div>
            <Field v-model="userInfo.email" readonly class="google-code-page__field !rounded-sm" :border="false" />
          </div>
          <div class="mb-1">
            <div class="text-[#000] text-[0.28rem] mb-1">{{ t('bind_google_step3_your_key') }}</div>
            <Field
              clearable
              center
              size="large"
          ...
          <Button type="primary" block round class="google-code-page__btn" @click="step = 4">
      ...
      <template v-if="step === 4">
        ...
        <div class="p-1 pb-10">
          <div class="mb-4">
            <div class="text-[#000] text-[0.28rem] mb-2">{{ t('bind_google_step4_code') }}</div>
            <Field
              v-model="code"
              type="digit"
              :maxlength="6"
          ...
          <Button type="primary" block round :loading="loading" class="google-code-page__btn" @click="submitBind">
...
<style scoped lang="less">
  ...
  .google-code-page__field {
    background: #f9faff !important;
    box-shadow: 0 0 2px rgba(87, 119, 251, 0.25);
  }

  .google-code-page__btn.van-button--primary {
    background: linear-gradient(180deg, #92b6ff 0%, #2a61f9 100%);
    border: none;
    color: #ffffff;
  }

  .google-code-page__outline-btn.van-button--primary {
    background: transparent !important;
    border-color: #2a61f9 !important;
    color: #2a61f9 !important;
  }
</style>
