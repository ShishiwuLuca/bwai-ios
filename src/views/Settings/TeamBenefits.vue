      ...
      <List v-model:loading="loading" :finished="finished" @load="onLoad">
        ...
        <div v-if="teamRewardCards.length > 0" class="p-[0.32rem] pb-[0.48rem]">
          <div
            ...
            :key="item.level"
            class="team-benefits-page__card box-border mb-[0.32rem] border border-solid border-transparent rounded-[0.24rem] px-[0.32rem] pb-[0.32rem] pt-[0.36rem] last:mb-0"
            :class="isLevelUnlocked(item.level) ? '!border-[#2071f8]' : ''"
          >
            <div class="flex items-start gap-[0.24rem]">
              ...
              <div class="min-w-0 flex-1 pt-[0.04rem]">
                <div class="text-[0.3rem] font-bold leading-[1.2] !text-[#E87512]"
                  >VIP {{ item.level }}</div
                >
                <div
            ...
            <div class="pt-[0.24rem] text-[0.26rem] leading-[1.45] text-[#333]">
