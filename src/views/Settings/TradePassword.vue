    ...
    <div class="p-1">
      ...
      <div class="mt-1">
        <Field
          ...
          size="large"
          :border="false"
          class="trade-pwd-page__field rounded-sm overflow-hidden"
          autocomplete="off"
          type="text"
        ...
        <Field
          ...
          size="large"
          :border="false"
          class="trade-pwd-page__field rounded-sm overflow-hidden mt-1"
          type="digit"
          :maxlength="6"
          autocomplete="off"
        ...
        >
          <template #button>
            <Button
              ...
              block
              round
              class="rounded-sm overflow-hidden min-w-[1rem] trade-pwd-page__send-btn"
      ...
      <div class="mt-2">
        <Button
          ...
          round
          :loading="loading"
          class="trade-pwd-page__submit-btn"
          @click="onSubmit"
        >
          {{ t('confirm') }}
        </Button>
...
<style lang="less" scoped>
  ...
  .trade-pwd-page__submit-btn.van-button--primary {
    background: linear-gradient(180deg, #92b6ff 0%, #2a61f9 100%);
    border: none;
    color: #ffffff;
  }

  .trade-pwd-page__send-btn.van-button--primary {
